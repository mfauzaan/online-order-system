        ...
        <nav class="collapse ct-links" id="ct-docs-nav">
          ...
          <div class="ct-toc-item active">
            <ul class="nav ct-sidenav ">
              <li href="/logs" class="ct-sidenav-active {{ Request::is('admin/restaurants*') ? 'active' : '' }}"><a href="/admin/customers/restaurants.index">Restaurants</a></li>
              <li href="/logs" class="ct-sidenav-active {{ Request::is('customers/orders*') ? 'active' : '' }}"><a href="{{ route('orders.index') }}">History</a></li>
            </ul>
          </div>
