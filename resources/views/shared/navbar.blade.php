  ...
  <div class="container">
    <div class="header-inner header-md-height">
                    ...
                    <div class="notification-item unread clearfix">
                      <div class="heading">
                        <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                          <img width="30" height="30" data-src-retina="/img/profiles/1x.jpg" data-src="/img/profiles/1.jpg"
                            alt="" src="/img/profiles/1.jpg">
                        </div>
                        <a href="#" class="text-complete pull-left">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown pull-right sm-m-r-5">
          <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
            ...
            <span class="thumbnail-wrapper d32 circular inline">
              <img src="/img/profiles/avatar.jpg" alt="" data-src="/img/profiles/avatar.jpg" data-src-retina="/img/profiles/avatar_small2x.jpg"
                width="32" height="32">
            </span>
          </button>
        ...
        <!-- END User Info-->
        <a href="#" class="header-icon pg pg-alt_menu btn-link m-l-10 sm-no-margin d-inline-block" data-toggle="quickview"
    ...
    <div class="header-inner justify-content-start header-lg-height title-bar">
      <div class="brand inline align-self-end">
        <img src="/img/logo_s.png" alt="logo" data-src="/img/logo_s.png" data-src-retina="/img/logo_s_2x.png" width="17"
          height="20">
      </div>
